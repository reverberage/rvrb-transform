"""Provider contract for rvrb-transform.
...
from rvrb_transform.models import ProviderError, ToolCall, ToolResult
...
def get_provider(
    ...
    provider : str | None
        ...
        local for standalone operation.
...
def _wrap_error(model_id: str, exc: Exception) -> ProviderError:
    ...
    This fallback does NOT inspect provider-specific error codes.
    Those checks belong in the upstream n3rverberage providers, not in
    satellite fallback code.
    """
